...
- Set the `<meta name="apple-mobile-web-app-capable" content="yes">` meta tag. Set the <meta name="apple-mobile-web-app-capable" content="yes"> meta tag. A-Frame will inject this if missing. this if missing.
